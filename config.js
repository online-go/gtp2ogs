...
exports.updateFromArgv = function() {
    let optimist = require("optimist")
        ...
        .describe('minmaintimeblitz', 'Minimum seconds of main time for blitz (rejects time control simple and none)')
        .default('minmaintimeblitz', '15') // 15 seconds
        .describe('maxmaintimeblitz', 'Maximum seconds of main time for blitz (rejects time control simple and none)')
        .default('maxmaintimeblitz', '300') // 5 minutes 
        .describe('minmaintimeblitzranked', 'Minimum seconds of main time for blitz ranked games (rejects time control simple and none)')
        .describe('maxmaintimeblitzranked', 'Maximum seconds of main time for blitz ranked games (rejects time control simple and none)')
        .describe('minmaintimeblitzunranked', 'Minimum seconds of main time for blitz unranked games (rejects time control simple and none)')
        .describe('maxmaintimeblitzunranked', 'Maximum seconds of main time for blitz unranked games (rejects time control simple and none)')
        .describe('minmaintimelive', 'Minimum seconds of main time for live AND blitz (rejects time control simple and none)')
        .default('minmaintimelive', '60') // 1 minute
        .describe('maxmaintimelive', 'Maximum seconds of main time for live AND blitz (rejects time control simple and none)')
        .default('maxmaintimelive', '7200') // 2 hours 
        .describe('minmaintimeliveranked', 'Minimum seconds of main time for live AND blitz ranked games (rejects time control simple and none)')
        .describe('maxmaintimeliveranked', 'Maximum seconds of main time for live AND blitz ranked games (rejects time control simple and none)')
        .describe('minmaintimeliveunranked', 'Minimum seconds of main time for live AND blitz unranked games (rejects time control simple and none)')
        .describe('maxmaintimeliveunranked', 'Maximum seconds of main time for live AND blitz unranked games (rejects time control simple and none)')
        .describe('minmaintimecorr', 'Minimum seconds of main time for correspondence (rejects time control simple and none)')
        .default('minmaintimecorr', '259200') // 3 days
        .describe('maxmaintimecorr', 'Maximum seconds of main time for correspondence (rejects time control simple and none)')
        .default('maxmaintimecorr', '604800') // 7 days
        .describe('minmaintimecorrranked', 'Minimum seconds of main time for correspondence ranked games (rejects time control simple and none)')
        .describe('maxmaintimecorrranked', 'Maximum seconds of main time for correspondence ranked games (rejects time control simple and none)')
        .describe('minmaintimecorrunranked', 'Minimum seconds of main time for correspondence unranked games (rejects time control simple and none)')
        .describe('maxmaintimecorrunranked', 'Maximum seconds of main time for correspondence unranked games (rejects time control simple and none)')
